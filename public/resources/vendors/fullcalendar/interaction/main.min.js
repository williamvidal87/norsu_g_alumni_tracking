...
!function(e, t) {
    ...
    t(e.FullCalendarInteraction = {}, e.FullCalendar))
}(this, function(e, t) {
    "use strict";
    function n(e, t) {
        function n() {
    ...
    function d(e) {
        ...
        return null == t && (t = e.opt("longPressDelay")),
        t
    }
    function u(e, n, r) {
        var i = e.dateSpan
    ...
    function g(e, n, r) {
        var i = e.dateSpan
          ...
          , l = o.range.start
          , s = {};
        i.allDay !== o.allDay && (s.allDay = o.allDay,
    ...
    function p(e, n, r, i, o) {
        ...
        if (r) {
            if (a.add(i.start, c) < i.end)
                return d.startDelta = c,
                d
        } else if (a.add(i.end, c) > i.start)
            return d.endDelta = c,
            d;
        return null
    }
    ...
    var y = 0
      ...
      , A = function() {
        ...
        e.prototype.handleMove = function(e, t) {
            ...
            !t && c(this.movingHit, n) || (this.movingHit = n,
            ...
            for (var l in i) {
                ...
                if (c.isWithinClipping(e, n)) {
                    ...
                    if (g >= 0 && g < v && h >= 0 && h < f) {
                        ...
                        !E || s.props.dateProfile && !t.rangeContainsRange(s.props.dateProfile.activeRange, E.dateSpan.range) || a && !(E.layer > a.layer) || (E.rect.left += d,
                        E.rect.right += d,
                        E.rect.top += u,
                        E.rect.bottom += u,
                        a = E)
        ...
        function r(n) {
            ...
            r.handleHitUpdate = function(e, n) {
                var i = r.component.calendar
                  , o = null
                  , a = !1;
                e && ((o = u(r.hitDragging.initialHit, e, i.pluginSystem.hooks.dateSelectionTransformers)) && r.component.isDateSelectionValid(o) || (a = !0,
                o = null)),
                o ? i.dispatch({
                    type: "SELECT_DATES",
                    selection: o
            ...
            r.handlePointerUp = function(e) {
                r.dragSelection && (r.component.calendar.triggerDateSelect(r.dragSelection, e),
                r.dragSelection = null)
            }
            ;
            var i = n.component
      ...
      , V = function(e) {
        function r(n) {
            ...
            i.handlePointerDown = function(e) {
                ...
                a.delay = e.isTouch && u !== o.props.eventSelection ? h(o) : null,
                l.parentNode = s.el,
                l.revertDuration = o.opt("dragRevertDuration");
                var g = o.isValidSegDownEl(n) && !t.elementClosest(n, ".fc-resizer");
                a.setIgnoreMove(!g),
                i.isDragging = g && e.subjectEl.classList.contains("fc-draggable")
            }
            ,
            ...
            i.handleHitUpdate = function(e, n) {
                if (i.isDragging) {
                    ...
                    if (e) {
                        var p = e.component;
                        l = p.calendar,
                        a === l || p.opt("editable") && p.opt("droppable") ? (s = g(o, e, l.pluginSystem.hooks.eventDragMutationMassagers)) && (d = t.applyMutationToEventStore(r, l.eventUiBases, s, l),
                        h.mutatedEvents = d,
                        i.component.isInteractionValid(h) || (u = !0,
                        s = null,
                        d = null,
                        h.mutatedEvents = t.createEmptyEventStore())) : l = null
                    }
                    i.displayDrag(l, h),
                    u ? t.disableCursor() : t.enableCursor(),
                    n || (a === l && c(o, e) && (s = null),
                    i.dragging.setMirrorNeedsRevert(!s),
                    i.dragging.setMirrorIsVisible(!e || !document.querySelector(".fc-mirror")),
            ...
            i.handleDragEnd = function(e) {
                if (i.isDragging) {
                    ...
                    i.validMutation) {
                        ...
                        n.publiclyTrigger("_noEventDrop")
                }
                i.cleanup()
            }
            ;
        ...
        function r(n) {
            ...
            r.handleDragStart = function(e) {
                var n = r.component.calendar
                  , i = r.eventRange;
                r.relevantEvents = t.getRelevantEvents(n.state.eventStore, r.eventRange.instance.instanceId),
            ...
            r.handleHitUpdate = function(e, n, i) {
                ...
                e && (d = p(l, e, i.subjectEl.classList.contains("fc-start-resizer"), s.range, o.pluginSystem.hooks.eventResizeJoinTransforms)),
                d && (u = t.applyMutationToEventStore(a, o.eventUiBases, d, o),
                h.mutatedEvents = u,
                r.component.isInteractionValid(h) || (g = !0,
                d = null,
                u = null,
      ...
      , X = function() {
        function e(e, n) {
            ...
            this.handleHitUpdate = function(e, n, i) {
                ...
                e && (a = e.component.calendar,
                r.canDropElOnCalendar(i.subjectEl, a) && (l = v(e.dateSpan, r.dragMeta, a),
                c.mutatedEvents = t.eventTupleToStore(l),
                (s = !t.isInteractionValid(c, a)) && (c.mutatedEvents = t.createEmptyEventStore(),
                l = null))),
                r.displayDrag(a, c),
                o.setMirrorIsVisible(n || !l || !document.querySelector(".fc-mirror")),
                s ? t.disableCursor() : t.enableCursor(),
                n || (o.setMirrorNeedsRevert(!l),
