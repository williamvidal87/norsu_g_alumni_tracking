...
*/
!function(e, t) {
    "object" == typeof exports && "undefined" != typeof module ? t(exports, require("@fullcalendar/core")) : "function" == typeof define && define.amd ? define(["exports", "@fullcalendar/core"], t) : (e = e || self,
    t(e.FullCalendarDayGrid = {}, e.FullCalendar))
}(this, function(e, t) {
    "use strict";
    function r(e, t) {
        function r() {
    ...
    function n(e, t) {
        ...
        for (r = 0; r < t.length; r++)
            if (n = t[r],
            n.firstCol <= e.lastCol && n.lastCol >= e.firstCol)
                return !0;
        return !1
    }
    function i(e, t) {
    ...
    function o(e, r, n, i) {
        ...
        return a.unshift("fc-day", s.getClass("widgetContent")),
        '<td class="' + a.join(" ") + '"' + (l ? ' data-date="' + o.formatIso(e, {
            omitTime: !0
        }) + '"' : "") + (i ? " " + i : "") + "></td>"
    }
    function s(e, r) {
    ...
    var l = function(e, t) {
      ...
      , d = function(e) {
        ...
        n.prototype.buildRenderRange = function(r, n, i) {
            ...
            if (/^(year|month)$/.test(n) && (a = s.startOfWeek(a),
            o = s.startOfWeek(d),
      ...
      , c = function() {
        ...
        e.prototype.position = function() {
            var e, r, n = this.options, i = this.el, o = i.getBoundingClientRect(), s = t.computeRect(i.offsetParent), l = t.computeClippingRect(n.parentEl);
            e = n.top || 0,
      ...
      , h = function(e) {
        ...
        n.prototype.renderSegHtml = function(e, r) {
            var n, i, o = this.context.options, s = e.eventRange, l = s.def, a = s.ui, d = l.allDay, c = a.startEditable, h = d && e.isStart && a.durationEditable && o.eventResizableFromStart, p = d && e.isEnd && a.durationEditable, u = this.getSegClasses(e, c, h || p, r), f = t.cssToStr(this.getSkinCss(a)), g = "";
            ...
            '<a class="' + u.join(" ") + '"' + (l.url ? ' href="' + t.htmlEscape(l.url) + '"' : "") + (f ? ' style="' + f + '"' : "") + '><div class="fc-content">' + ("rtl" === o.dir ? i + " " + g : g + " " + i) + "</div>" + (h ? '<div class="fc-resizer fc-start-resizer"></div>' : "") + (p ? '<div class="fc-resizer fc-end-resizer"></div>' : "") + "</a>"
        }
        ,
      ...
      , p = function(e) {
        ...
        o.prototype.renderSegRow = function(e, r) {
            function n(e) {
                for (; s < e; )
                    c = (b[i - 1] || [])[s],
                    c ? c.rowSpan = (c.rowSpan || 1) + 1 : (c = document.createElement("td"),
                    l.appendChild(c)),
                    v[i][s] = c,
                    b[i][s] = c,
                    s++
            }
            var i, o, s, l, a, d, c, h = this.dayGrid, p = h.colCnt, u = h.isRtl, f = this.buildSegLevels(r), g = Math.max(1, f.length), m = document.createElement("tbody"), y = [], v = [], b = [];
            for (i = 0; i < g; i++) {
                if (o = f[i],
                s = 0,
                ...
                o)
                    for (a = 0; a < o.length; a++) {
                        ...
                        w !== S ? c.colSpan = S - w + 1 : b[i][s] = c; s <= S; )
                            v[i][s] = c,
                            y[i][s] = d,
                            s++;
                        l.appendChild(c)
      ...
      , f = function(e) {
        ...
        n.prototype.renderFillRow = function(e, r) {
            var n, i, o, s = this.dayGrid, l = s.colCnt, a = s.isRtl, d = a ? l - 1 - r.lastCol : r.firstCol, c = a ? l - 1 - r.firstCol : r.lastCol, h = d, p = c + 1;
            ...
            r.el.colSpan = p - h,
            o.appendChild(r.el),
            p < l && t.appendToElement(o, new Array(l - p + 1).join("<td></td>"));
            var u = s.renderProps.renderIntroHtml();
            return u && (s.isRtl ? t.appendToElement(o, u) : t.prependToElement(o, u)),
            i
        }
        ,
        n
      ...
      , g = function(e) {
        function n(r, n) {
            ...
            return i.renderFgEvents = t.memoizeRendering(o.renderSegs.bind(o), o.unrender.bind(o), [s]),
        ...
        n.prototype._renderFrame = function(e) {
            ...
            this.el.innerHTML = '<div class="fc-header ' + n.getClass("popoverHeader") + '"><span class="fc-title">' + t.htmlEscape(o) + '</span><span class="fc-close ' + n.getIconClass("close") + '"></span></div><div class="fc-body ' + n.getClass("popoverContent") + '"><div class="fc-event-container"></div></div>',
      ...
      , w = function(e) {
        function n(r, n, i) {
            ...
            o.bottomCoordPadding = 0,
            o.isCellSizesDirty = !1;
            ...
            return o.renderBusinessHours = t.memoizeRendering(l.renderSegs.bind(l, "businessHours"), l.unrender.bind(l, "businessHours"), [a]),
            o.renderDateSelection = t.memoizeRendering(l.renderSegs.bind(l, "highlight"), l.unrender.bind(l, "highlight"), [a]),
            o.renderBgEvents = t.memoizeRendering(l.renderSegs.bind(l, "bgEvent"), l.unrender.bind(l, "bgEvent"), [a]),
            o.renderFgEvents = t.memoizeRendering(s.renderSegs.bind(s), s.unrender.bind(s), [a]),
            o.renderEventSelection = t.memoizeRendering(s.selectByInstanceId.bind(s), s.unselectByInstanceId.bind(s), [o.renderFgEvents]),
            o.renderEventDrag = t.memoizeRendering(o._renderEventDrag, o._unrenderEventDrag, [a]),
            o.renderEventResize = t.memoizeRendering(o._renderEventResize, o._unrenderEventResize, [a]),
            o.renderProps = i,
            o
        }
        return r(n, e),
        ...
        n.prototype._renderCells = function(e, r) {
            ...
            for (n = 0; n < d; n++)
                h += this.renderDayRowHtml(n, r);
            for (this.el.innerHTML = h,
            ...
            this.colPositions = new t.PositionCache(this.el,this.cellEls.slice(0, c),!0,!1),
            n = 0; n < d; n++)
                for (i = 0; i < c; i++)
        ...
        n.prototype.renderNumberCellsHtml = function(e) {
            ...
            return this.isRtl && n.reverse(),
            n.join("")
        }
        ,
        n.prototype.renderNumberCellHtml = function(e) {
            var r, n, i = this, o = i.view, s = i.dateEnv, l = "", a = t.rangeContainsMarker(this.props.dateProfile.activeRange, e), d = this.getIsDayNumbersVisible() && a;
            return d || this.renderProps.cellWeekNumbersVisible ? (r = t.getDayClasses(e, this.props.dateProfile, this.context),
            r.unshift("fc-day-top"),
            this.renderProps.cellWeekNumbersVisible && (n = s.weekDow),
            l += '<td class="' + r.join(" ") + '"' + (a ? ' data-date="' + s.formatIso(e, {
                omitTime: !0
            }) + '"' : "") + ">",
        ...
        n.prototype.updateSize = function(e) {
            var t = this
              ...
              , n = t.eventRenderer
              , i = t.mirrorRenderer;
            (e || this.isCellSizesDirty) && (this.buildColPositions(),
        ...
        n.prototype.limitRows = function(e) {
            ...
            for (t = 0; t < n.length; t++)
                this.unlimitRow(t),
                !1 !== (r = !!e && ("number" == typeof e ? e : this.computeRowLevelLimit(t))) && this.limitRow(t, r)
        }
        ,
        n.prototype.computeRowLevelLimit = function(e) {
            var r, n, i = this.rowEls[e], o = i.getBoundingClientRect().bottom, s = t.findChildren(this.eventRenderer.rowStructs[e].tbodyEl);
        ...
        n.prototype.limitRow = function(e, r) {
            var n, i, o, s, l, a, d, c, h, p, u, f, g, m, y, v = this, b = this, w = b.colCnt, S = b.isRtl, C = this.eventRenderer.rowStructs[e], E = [], R = 0, H = function(n) {
                for (; R < n; )
        ...
        n.prototype.unlimitRow = function(e) {
            ...
            r.moreEls && (r.moreEls.forEach(t.removeElement),
            r.moreEls = null),
            r.limitedEls && (r.limitedEls.forEach(function(e) {
        ...
        n.prototype.renderMoreLink = function(e, r, n) {
            ...
            return a.innerText = this.getMoreLinkText(n.length),
        ...
        n.prototype.showSegPopover = function(e, r, n, i) {
            var o, s, l = this, a = this, d = a.calendar, h = a.view, p = a.theme, u = this.isRtl ? this.colCnt - r - 1 : r, f = n.parentNode;
            ...
            this.isRtl ? s.right = t.computeRect(f).right + 1 : s.left = t.computeRect(f).left - 1,
        ...
        n.prototype.getCellSegs = function(e, t, r) {
            for (var n, i = this.eventRenderer.rowStructs[e].segMatrix, o = r || 0, s = []; o < i.length; )
                n = i[o][t],
                n && s.push(n),
                o++;
            return s
      ...
      , C = function(e) {
        function n(r, n, i, o) {
            ...
            l.appendChild(a);
            var d;
            return s.opt("weekNumbers") ? s.opt("weekNumbersWithinDays") ? (d = !0,
            s.colWeekNumbersVisible = !1) : (d = !1,
            s.colWeekNumbersVisible = !0) : (s.colWeekNumbersVisible = !1,
            d = !1),
        ...
        n.prototype.updateBaseSize = function(e, r, n) {
            ...
            if (!s.rowEls)
                return void (n || (i = this.computeScrollerHeight(r),
            ...
            (o.left || o.right) && (a && t.compensateScroll(a, o),
            i = this.computeScrollerHeight(r),
            this.scroller.setHeight(i)),
        ...
        n.prototype.setGridHeight = function(e, r) {
            this.opt("monthMode") ? (r && (e *= this.dayGrid.rowCnt / 6),
            t.distributeHeight(this.dayGrid.rowEls, e, !r)) : r ? t.undistributeHeight(this.dayGrid.rowEls) : t.distributeHeight(this.dayGrid.rowEls, e, !0)
        }
        ,
    ...
    var E = function(e) {
      ...
      , H = function(e) {
        function n(r, n, i, o) {
            ...
            return l.buildDayTable = t.memoize(s),
            l.opt("columnHeader") && (l.header = new t.DayHeader(l.context,l.el.querySelector(".fc-head-container"))),
