...
!function(e, t) {
    ...
    function t(e, t, n) {
        ...
        if (t)
            for (var i in t)
                "style" === i ? g(r, t[i]) : ci[i] ? r[i] = t[i] : r.setAttribute(i, t[i]);
    ...
    function Mt(e) {
        var t, n;
        return function() {
            return t && Ct(t, arguments) || (t = arguments,
    ...
    function Vt(e, t) {
        ...
        new ki(e)) : "string" == typeof e ? new Oi(e,t) : "function" == typeof e ? new _i(e) : void 0
    }
    function At(e, t, n) {
        void 0 === n && (n = !1);
        var r = e.toISOString();
    ...
    function hn(e, t, n, r) {
        ...
        for (var p in s) {
            var h = s[p]
              ...
              , g = u[h.defId]
              , y = a[h.defId];
            if (!gn(g.constraints, v, l, e.businessHours, t))
                return !1;
            ...
            for (var E in d) {
                ...
                if (Tt(v, S.range)) {
                    ...
                    if (!1 === g.overlap)
                        return !1;
                    if (m && !m(new xi(t,c[S.defId],S), new xi(t,y,h)))
                        return !1
                }
            }
            for (var D = 0, T = g.allows; D < T.length; D++) {
                ...
                if (!b(t.buildDateSpanApi(I), new xi(t,w,R)))
                    return !1
            }
        }
        return !0
    ...
    function vn(e, t, n, r) {
        var i = e.eventStore
          ...
          , l = t.selectionConfig;
        if (r && (l = r(l)),
        !gn(l.constraints, u, i, e.businessHours, t))
            return !1;
    ...
    function Fn(e, t, n, r) {
        ...
        return wt(t.activeRange, e) ? (c.push("fc-" + yi[e.getUTCDay()]),
    ...
    function ur(e) {
        var t = null
          ...
          , r = Eo.exec(e);
        r && (n = !r[1],
        n ? e += "T00:00:00Z" : e = e.replace(So, function(e, n, r, i, o) {
    ...
    function cr(e, t) {
        for (var n = t.pluginSystem.hooks.eventSourceDefs, r = n.length - 1; r >= 0; r--) {
            var i = n[r]
              , o = i.parseMeta(e);
            if (o)
                return dr("object" == typeof e ? e : {}, o, r, t)
        }
        return null
    }
    function dr(e, t, n, r) {
    ...
    function Er(e, t, n, r) {
        var i, o = e[t];
        return o && n === o.latestFetchId ? Di({}, e, (i = {},
        i[t] = Di({}, o, {
            isFetching: !1,
            fetchRange: r
        }),
    ...
    function ui(e, t, n, r, i, o, a, s) {
        var u, l = o.view, c = o.dateEnv, d = o.theme, f = o.options, p = wt(t.activeRange, e), h = ["fc-day-header", d.getClass("widgetHeader")];
    ...
    var ci = {
      ...
      , ki = function() {
        function e(e) {
            ...
            for (var i in e)
                i in Ti ? (n[i] = e[i],
                r = Math.max(Ti[i], r)) : (t[i] = e[i],
                i in bi && (r = Math.max(bi[i], r)));
      ...
      , Wi = function(e) {
        ...
        t.prototype.on = function(e, t) {
            return Zn(this._handlers || (this._handlers = {}), e, t),
            this
        }
        ,
        t.prototype.one = function(e, t) {
            return Zn(this._oneHandlers || (this._oneHandlers = {}), e, t),
            this
        }
        ,
        ...
        t.prototype.triggerWith = function(e, t, n) {
            ...
            this._oneHandlers && (je(this._oneHandlers[e], t, n),
    ...
    var $i = 0
      ...
      , go = function() {
        ...
        e.prototype.compute = function() {
            ...
            this.computed = er([co, o, r, this.overrides, this.dynamicOverrides])
        }
        ,
        e
    }()
    ...
    var Eo = /^\s*\d{4}-\d\d-\d\d([T ]\d)?/
      ...
      , Do = function() {
        function e(e) {
            ...
            this.weekDoy = 4) : "number" == typeof e.firstDay && (this.weekDow = e.firstDay),
        ...
        e.prototype.createMarkerMeta = function(e) {
            ...
            isNaN(e) || (t = this.timestampToMarker(e))) : Array.isArray(e) && (t = oe(e)),
            null !== t && ae(t) ? {
                marker: t,
                isTimeUnspecified: !1,
                forcedTzo: null
      ...
      , Ro = function() {
        ...
        e.prototype.buildCurrentRangeInfo = function(e, t) {
            ...
            return i.duration ? (a = i.duration,
            s = i.durationUnit,
            u = this.buildRangeFromDuration(e, t, a, s)) : (n = this.options.dayCount) ? (s = "day",
            u = this.buildRangeFromDayCount(e, t, n)) : (u = this.buildCustomVisibleRange(e)) ? s = o.greatestWholeUnit(u.start, u.end).unit : (a = this.getFallbackDuration(),
            s = we(a).unit,
        ...
        e.prototype.adjustActiveRange = function(e, t, n) {
            var r = this.dateEnv
              , i = e.start
              , o = e.end;
            return this.viewSpec.class.prototype.usesMinMaxTime && (Ee(t) < 0 && (i = X(i),
            i = r.add(i, t)),
            Ee(n) > 1 && (o = X(o),
            o = V(o, -1),
            o = r.add(o, n))),
        ...
        e.prototype.buildRangeFromDuration = function(e, t, n, r) {
            ...
            return d || (o = this.options.dateIncrement,
            o ? (a = ue(o),
            d = Te(a) < Te(n) ? we(a, !de(o)).unit : r) : d = r),
            Ee(n) <= 1 && this.isHiddenDay(s) && (s = this.skipHiddenDays(s, t),
            s = X(s)),
            i(),
      ...
      , Mo = function(e) {
        function r(n, r) {
            ...
            i._updateActiveButton = Ln(i.updateActiveButton, null, [i._renderLayout]),
        ...
        r.prototype.renderSection = function(e, r) {
            ...
            return r && r.split(" ").forEach(function(e, t) {
                ...
                if (e.split(",").forEach(function(e, t) {
                    ...
                    "title" === e ? (o.push(n("<h2>&nbsp;</h2>")),
                    l = !1) : ((r = f[e]) ? (d = function(e) {
                        r.click && r.click.call(E, e)
                    }
                    ,
                    (v = s.getCustomButtonIconClass(r)) || (v = s.getIconClass(e)) || (g = r.text)) : (a = c[e]) ? (i.viewsWithButtons.push(e),
                    d = function() {
                        u.changeView(e)
                    }
                    ,
                    ...
                    ,
                    (g = p[e]) || (v = s.getIconClass(e)) || (g = h[e])),
                    d && (m = ["fc-" + e + "-button", s.getClass("button")],
                    g ? (y = Dn(g),
                    S = "") : v && (y = "<span class='" + v + "'></span>",
                    S = ' aria-label="' + e + '"'),
                    E = n('<button type="button" class="' + m.join(" ") + '"' + S + ">" + y + "</button>"),
      ...
      , ko = function(e) {
        ...
        n.prototype.renderToolbars = function(e, t, n, r, i) {
            ...
            o ? (this.header || (this.header = new Mo(this.context,"fc-header-toolbar"),
            s(this.el, this.header.el)),
            this.header.receiveProps(Di({
                layout: o
            }, p))) : this.header && (this.header.destroy(),
            this.header = null),
            u ? (this.footer || (this.footer = new Mo(this.context,"fc-footer-toolbar"),
            a(this.el, this.footer.el)),
            this.footer.receiveProps(Di({
                layout: u
        ...
        n.prototype.computeHeightVars = function() {
            ...
            this.viewHeight = "number" == typeof n ? n : "function" == typeof n ? n() : "number" == typeof t ? t - this.queryToolbarsHeight() : "function" == typeof t ? t() - this.queryToolbarsHeight() : "parent" === t ? this.el.parentNode.offsetHeight - this.queryToolbarsHeight() : Math.round(this.contentEl.offsetWidth / Math.max(e.opt("aspectRatio"), .5))
        }
        ,
      ...
      , xo = function(e) {
        function t(t) {
            ...
            n.handleSegEnter = function(e, t) {
                Xt(t) && (t.classList.add("fc-allow-mouse-resize"),
                n.currentSegEl = t,
    ...
    var No = function() {
        ...
        e.prototype.render = function() {
            this.component ? this.requestRerender(!0) : (this.renderableEventStore = ht(),
            this.bindHandlers(),
            this.executeRender())
        }
        ,
        ...
        e.prototype.renderComponent = function(e) {
            ...
            if (!o)
                throw new Error('View type "' + i + '" is not valid');
            ...
            !e && r || (r && (r.freezeHeight(),
            r.destroy()),
            r = this.component = new ko({
                calendar: this,
                view: null,
                dateEnv: this.dateEnv,
                theme: this.theme,
        ...
        e.prototype.setOption = function(e, t) {
            ...
            this.handleOptions(this.optionsManager.computed),
            "height" === e || "contentHeight" === e || "aspectRatio" === e ? this.updateSize() : "defaultDate" === e || "defaultView" === e || /^(event|select)(Overlap|Constraint|Allow)$/.test(e) || (this.needsFullRerender = !0,
            this.batchRendering(function() {
        ...
        e.prototype.changeView = function(e, t) {
            var n = null;
            t && (t.start && t.end ? (this.optionsManager.add("visibleRange", t),
        ...
        e.prototype.getUnitViewSpec = function(e) {
            ...
            for (var i in this.viewSpecs)
                t.push(i);
            for (n = 0; n < t.length; n++)
                if ((r = this.viewSpecs[t[n]]) && r.singleUnit === e)
                    return r
        }
        ,
        ...
        e.prototype.getEventById = function(e) {
            ...
            for (var i in n) {
                ...
                if (o.publicId === e) {
                    if (o.recurringDef)
                        return new xi(this,o,null);
                    for (var a in r) {
                        var s = r[a];
                        if (s.defId === o.defId)
                            return new xi(this,o,s)
                    }
                }
            }
            return null
    ...
    var zo = function(e) {
        function n(n, r, i, o) {
            ...
            a.renderBusinessHoursMem = Ln(a.renderBusinessHours, a.unrenderBusinessHours, [a.renderDatesMem]),
            a.renderDateSelectionMem = Ln(a.renderDateSelectionWrap, a.unrenderDateSelectionWrap, [a.renderDatesMem]),
            a.renderEventsMem = Ln(a.renderEvents, a.unrenderEvents, [a.renderDatesMem]),
            a.renderEventSelectionMem = Ln(a.renderEventSelectionWrap, a.unrenderEventSelectionWrap, [a.renderEventsMem]),
            a.renderEventDragMem = Ln(a.renderEventDragWrap, a.unrenderEventDragWrap, [a.renderDatesMem]),
            a.renderEventResizeMem = Ln(a.renderEventResizeWrap, a.unrenderEventResizeWrap, [a.renderDatesMem]),
            a.viewSpec = r,
        ...
        n.prototype.startNowIndicator = function(e) {
            ...
            r = o.add(o.startOf(this.initialNowDate, t), ue(1, t)).valueOf() - this.initialNowDate.valueOf(),
        ...
        n.prototype.updateNowIndicator = function() {
            ...
            this.renderNowIndicator(A(this.initialNowDate, (new Date).valueOf() - this.initialNowQueriedMs)),
        ...
        n.prototype.applyScroll = function(e, t) {
            e.isDateInit && (delete e.isDateInit,
