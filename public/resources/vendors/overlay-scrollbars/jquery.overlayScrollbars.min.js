...
!function(t, r) {
    ...
    "use strict";
    var i, o, vt = "OverlayScrollbars", dt = "object", ht = "function", bt = "array", pt = "string", mt = "boolean", wt = "number", d = "null", yt = "class", ki = "style", gt = "id", xt = "length", St = "prototype", Oi = "offsetHeight", Ai = "clientHeight", Li = "scrollHeight", Ci = "offsetWidth", Ni = "clientWidth", Di = "scrollWidth", Hi = {
        wW: function() {
    ...
    function(n, t) {
            ...
            d: (i = function(i) {
                var o = function(n) {
                    ...
                    for (t in n)
                        ...
                        (e = Hi.type(r)) == bt ? n[t] = r[i ? 1 : 0] : e == dt && (n[t] = o(r)));
                    return n
                };
                  ...
                  , O = function(n, t, r, e) {
                    for (var i in t)
                        if (t.hasOwnProperty(i) && n.hasOwnProperty(i)) {
                            var o, a, u, f, c, l, s, v, d = !1, h = t[i], b = Hi.type(h), p = b == dt, m = Hi.type(h) != bt ? [h] : h, w = n[i], y = Hi.type(w), g = e ? e + "." : "", x = 'The option "' + g + i + "\" wasn't set, because", S = [], z = [];
                            if (p && y == dt)
                                r[i] = {},
                                O(w, h, r[i], g + i),
                                ...
                                for (l = 0; l < m.length; l++)
                                    if (c = m[l],
                                    u = (b = Hi.type(c)) == pt && -1 === Ii.inArray(c, A))
                                        for (S.push(pt),
                                        o = c.split(" "),
                                        z = z.concat(o),
                                        s = 0; s < o.length; s++) {
                                ...
                                d ? r[i] = u && k ? f : w : T && console.warn(x + " it doesn't accept the type [ " + y.toUpperCase() + ' ] with the value of "' + w + '".\r\nAccepted types are: [ ' + S.join(", ").toUpperCase() + " ]." + (0 < z.length ? "\r\nValid strings are: [ " + z.join(", ").split(":").join(", ") + " ]." : "")),
                                delete n[i]
                            }
                        }
                };
                return O(i, t, e),
                r ? Ii.extend(!0, e, i) : !Ii.isEmptyObject(i) && T && console.warn("The following options are discarded due to invalidity:\r\n" + lt.JSON.stringify(i, null, 2)),
                e
            }
        });
        function l() {
        ...
        function o(n) {
            ...
            function p(n) {
                ...
                e[ki][n] !== Ti && (t = !0),
                !t)
                    for (i = n.charAt(0).toUpperCase() + n.substr(1); o < r.length; o++)
                        if (e[ki][r[o] + i] !== Ti) {
                            t = !0;
                            break
                        }
            ...
            Ii.extend(S, {
                ...
                nativeScrollbarStyling: (T.addClass("os-viewport-native-scrollbars-invisible"),
                T.css(i, o).hide().css(i, "scroll").show(),
                a[Oi] - a[Ai] == 0 && a[Ci] - a[Ni] == 0),
                overlayScrollbarDummySize: {
                    x: 30,
                    y: 30
                },
                msie: (r = lt.navigator.userAgent,
                u = "indexOf",
                f = "substring",
                c = r[u]("MSIE "),
                l = r[u]("Trident/"),
                ...
                t),
                cssCalc: function() {
                    var n, t, r = st.createElement("div"), e = ["calc", "-webkit-calc", "-moz-calc", "-o-calc"];
                    for (n = 0; n < e.length; ++n)
                        if (t = e[n],
                        r[ki].cssText = "width:" + t + "(1px);",
                        r[ki].length)
                            return t;
                    return null
                }(),
                ...
                if (!b.x || !b.y) {
                    ...
                    Ii(lt).on("resize", function() {
                        if (0 < Tt().length) {
                            ...
                            if (0 === r && 0 === e)
                                return;
                            var i, o = Ri.round(n / (w / 100)), a = Ri.round(t / (y / 100)), u = m(r), f = m(e), c = m(o), l = m(a), s = x(), v = 2 < u && 2 < f, d = !function p(n, t) {
                                var r = m(n)
                                  , e = m(t);
                                return !(r === e || r + 1 === e || r - 1 === e)
                            }(c, l), h = v && d && s !== g && 0 < g, b = S.nativeScrollbarSize;
                            h && (z.append(T),
                            i = S.nativeScrollbarSize = k(T[0]),
                            T.remove(),
                            b.x === i.x && b.y === i.y || Ii.each(Tt(), function() {
        ...
        function s(r) {
            var c, l = "autoUpdate", s = xt, v = [], d = [], h = !1, b = 33, p = Hi.now(), m = function() {
                if (0 < v[s] && h) {
                    c = Hi.rAF()(function() {
                        m()
                    });
                        ...
                        for (var r = 33, e = 0; e < v[s]; e++) {
                            ...
                            if (i !== Ti) {
                                var o = i.options()
                                  ...
                                  , f = Hi.now();
                                (!0 === a || null === a) && f - d[e] > u && (i.update("auto"),
                                d[e] = new Date(f += u)),
                                r = Ri.max(1, Ri.min(r, u))
                            }
                        }
                        b = r
                    }
        ...
        function v(e, n, t, Wt, _t) {
            if (rt(e)) {
                ...
                de.update = function(n) {
                    ...
                    r = function c() {
                        if (ir)
                            return !1;
                        var n, t = Pt && Tr && !Ur ? fr.val().length : 0, r = !ne && Tr && !Pt, e = {}, i = {};
                        Bt && (e = {
                            x: hr[0][Di],
                            y: hr[0][Li]
                        }),
                    ...
                    (t || r || i) && ui(!1, r, !1, i)) : "zoom" === n && ui(!0, !0) : (n = ir || n,
                    ui(ir = !1, !1, n, !0)),
                    Pt || pr.find("img").each(function(n, t) {
                    ...
                    if (Ii.isEmptyObject(n) || !Ii.isPlainObject(n)) {
                        ...
                        if (1 < arguments.length) {
                            ...
                            return function f(n, t, r) {
                                for (var e = t.split(q), i = e.length, o = 0, a = {}, u = a; o < i; o++)
                                    a = a[e[o]] = o + 1 < i ? {} : r;
                                Ii.extend(n, u, !0)
                            }(r, n, t),
                            Gn(r),
                ...
                de.scroll = function(n, t, r, e) {
                    ...
                    var w, s, v, d, h, y, g, b, p, x = Pr, m = [Re, ze, "l"], S = [Ie, ge, "t"], z = ["+=", "-=", "*=", "/="], T = ot(t) == dt, k = T ? t.complete : e, O = {}, A = {}, L = "begin", C = "nearest", N = "never", D = "ifneeded", H = xt, R = [Re, Ie, "xy", "yx"], I = [L, "end", "center", C], W = ["always", N, D], _ = n.hasOwnProperty("el"), j = _ ? n.el : n, F = !!(j instanceof Ii || zt) && j instanceof zt, M = !F && rt(j), U = ot(k) != ht ? Ti : function() {
                        s && si(!0),
                        v && si(!1),
                        k()
                    }
                    , E = function(n, t) {
                        ...
                        var r = n ? m : S;
                        if (ot(t = ot(t) == pt || ot(t) == wt ? [t, t] : t) == bt)
                            return n ? t[0] : t[1];
                        if (ot(t) == dt)
                            for (x = ot(t.n) == mt ? t.n : x,
                            w = 0; w < r[H]; w++)
                                if (r[w]in t)
                                    return t[r[w]]
                    }, q = function(n, t) {
                        var r, e, i = ot(t) == pt;
                        i && de.update(Ne + "+");
                        var o, a = n ? sn : vn, u = a.cs, f = a.ms, c = er && n, l = c && Mt.n && !x, s = "replace", v = eval;
                        if (i) {
                            if (2 < t[H]) {
                                var d = t.substr(0, 2);
                                for (w = 0; w < z[H]; w++)
                        ...
                        if (e !== Ti && !isNaN(e) && ot(e) == wt) {
                            ...
                            o = p ? f - o : o,
                            o *= m ? -1 : 1,
                            o = c && Mt.n ? Ri.min(0, Ri.max(f, o)) : Ri.max(0, Ri.min(f, o))
                        }
                        return o === u ? Ti : o
                    }, B = function(n, t, r, e) {
                        var i, o, a = [r, r], u = ot(n);
                        if (u == t)
                            n = [n, n];
                        else if (u == bt) {
                            if (2 < (i = n[H]) || i < 1)
                            ...
                            n = u == dt ? [n[Re] || r, n[Ie] || r] : a;
                        return {
                            x: n[0],
                            y: n[1]
                        }
                    }, X = function(n) {
                        var t, r, e = [], i = [ge, xe, Se, ze];
                        for (w = 0; w < n[H] && w !== i[H]; w++)
                            (r = ot(t = n[w])) == mt ? e.push(t ? bi(p.css(me + i[w])) : 0) : e.push(r == wt ? t : 0);
                        return e
                    };
                    if (F || M) {
                        var Y, P = _ ? n.margin : 0, $ = _ ? n.axis : 0, G = _ ? n.scroll : 0, J = _ ? n.block : 0, K = [0, 0, 0, 0], Q = ot(P);
                        if (0 === (p = F ? j : Ii(j))[H])
                            return;
                        de.update(Ne + "+"),
                        P = Q == wt || Q == mt ? X([P, P, P, P]) : Q == bt ? 2 === (Y = P[H]) ? X([P[0], P[1], P[0], P[1]]) : 4 <= Y ? X(P) : K : Q == dt ? X([P[ge], P[xe], P[Se], P[ze]]) : K,
                        h = E($, R) ? $ : "xy",
                        y = B(G, pt, "always", W),
                        g = B(J, pt, L, I),
                        b = P;
                        ...
                        if (er && (Mt.n || Mt.i || (on.x = Ri.round(tn[ze] - rn[ze] + Z)),
                        Mt.n && x && (on.x *= -1),
                        Mt.i && x && (on.x = Ri.round(tn[ze] - rn[ze] + (sn.ms - Z)))),
                        g.x != L || g.y != L || y.x == D || y.y == D || er) {
                            var an = p[0]
                              ...
                              , cn = function(n) {
                                var t = nt(n)
                                  ...
                                  , p = s + l / 2
                                  , m = v <= l && s <= d && d + v <= s + l;
                                f ? en[i] = !0 : en[i] || ((u || c) && (en[i] = !!c && m,
                                o = v < l ? p < b : b < p),
                                on[i] -= o || a ? (l / h - v / h) * (n && er && x ? -1 : 1) : 0)
                            };
                            cn(!0),
                            cn(!1)
                        }
                    ...
                    s = O[_e] !== Ti,
                    v = O[je] !== Ti,
                    (s || v) && (0 < t || T) ? T ? (t.complete = U,
                    hr.animate(O, t)) : (d = {
                        duration: t,
                        complete: U
                    },
                    ot(r) == bt || Ii.isPlainObject(r) ? (A[_e] = r[0] || r.x,
                    A[je] = r[1] || r.y,
                    d.specialEasing = A) : d.easing = r,
                    hr.animate(O, d)) : (s && hr[_e](O[_e]),
                    v && hr[je](O[je]))
                }
                ,
                de.scrollStop = function(n, t, r) {
                    return hr.stop(n, t, r),
                    de
                }
                ,
                ...
                de.addExt = function(n, t) {
                    var r, e, i, o, a = lt[vt].extension(n), u = !0;
                    if (a) {
                        if (_n.hasOwnProperty(n))
                            return de.ext(n);
                        if ((r = a.extensionFactory.call(de, xi(!0, {}, a.defaultOptions), Ii, Hi)) && (ot(i = r.contract) == ht && (u = ot(o = i(lt)) == mt ? o : u),
                        u))
                            return ot(e = (_n[n] = r).added) == ht && e(t),
                            de.ext(n)
                    } else
                ...
                de.removeExt = function(n) {
                    var t, r = _n[n];
                    return !!r && (delete _n[n],
                    ot(t = r.removed) == ht && t(),
                    !0)
                }
                ,
                function ft(n, t, r) {
                    return i = Wt.defaultOptions,
                    Et = Wt.nativeScrollbarStyling,
                    qt = xi(!0, {}, Wt.nativeScrollbarSize),
                    jt = xi(!0, {}, Wt.nativeScrollbarIsOverlaid),
                    Ft = xi(!0, {}, Wt.overlayScrollbarDummySize),
                    Mt = xi(!0, {}, Wt.rtlScrollBehavior),
                    Gn(xi(!0, {}, i, ct.v(t, ct.t, !0))),
                    jt.x && jt.x && !or.nativeScrollbarsOverlaid.initialize ? (di("onInitializationWithdrawn"),
                    !1) : (Vt = Wt.cssCalc,
                    C = Wt.msie,
                    Ut = Wt.autoUpdateRecommended,
                    v = Wt.supportTransition,
                    ln = Wt.supportTransform,
                    d = Wt.supportPassiveEvents,
                    N = Wt.supportResizeObserver,
                    c = Wt.supportMutationObserver,
                    Bt = Wt.restrictedMeasuring,
                    D = Ii(n.ownerDocument),
                    b = Ii(D[0].defaultView || D[0].parentWindow),
                    l = ut(D, "html"),
                    H = ut(l, "body"),
                    fr = Ii(n),
                    Pt = fr.is("textarea"),
                    $t = fr.is("body"),
                    h = D[0] !== st,
                    $t && ((e = {}).l = Ri.max(fr[_e](), l[_e](), b[_e]()),
                    e.t = Ri.max(fr[je](), l[je](), b[je]())),
                    Jn(),
                    Kn(),
                    Qn(),
                    Zn(!0),
                    ...
                    function f() {
                        ...
                        function r(n) {
                            if (a(n)) {
                                var t = u(n)
                                  , r = {};
                                (le || ce) && (r[Oe] = i.w + t.x - e.x),
                                (se || ce) && (r[Ae] = i.h + t.y - e.y),
                                cr.css(r),
                                Hi.stpP(n)
                            } else
                                o(n)
                        ...
                        function o(n) {
                            var t = n !== Ti;
                            D.off(Z, Yn).off($, r).off(P, o),
                            zi(H, In),
                            wr.releaseCapture && wr.releaseCapture(),
                            t && (U && ri(),
                            de.update(Ne)),
                            U = !1
                        }
                        ...
                        ve = function(n) {
                            ...
                            i.w = cr[0][Ci] - (Gt ? 0 : Kt),
                            i.h = cr[0][Oi] - (Gt ? 0 : Qt),
                            D.on(Z, Yn).on($, r).on(P, o),
                            Si(H, In),
                            wr.setCapture && wr.setCapture(),
                            Hi.prvD(n),
                            Hi.stpP(n))
                        }
                    }(),
                    En(),
                    $t && (hr[_e](e.l)[je](e.t),
                    st.activeElement == n && hr[0].focus && (hr.attr("tabindex", "-1"),
                    hr[0].focus(),
                    hr.one(Fe, function() {
                    ...
                    Xt = !0,
                    di("onInitialized"),
                    Ii.each(Wn, function(n, t) {
                        di(t.n, t.a)
                    }),
                    Wn = [],
                    ot(r) == pt && (r = [r]),
                    Hi.isA(r) ? Ii.each(r, function(n, t) {
                        de.addExt(t)
            ...
            function Fn(n, t, r) {
                for (var e = t.split(We), i = 0; i < e.length; i++)
            ...
            function ti(i, n) {
                var o = 3333333
                  ...
                  , e = "childNodes"
                  , a = function() {
                    i[je](o)[_e](er ? Mt.n ? -o : Mt.i ? 0 : o : o),
                    n()
                };
                if (N) {
                    ...
                    var f, c, l, s, v = i[0][e][0][e][0], d = Ii(v[e][1]), h = Ii(v[e][0]), b = Ii(h[0][e][0]), p = v[Ci], m = v[Oi], w = Wt.nativeScrollbarSize, y = function() {
                        h[_e](o)[je](o),
                        d[_e](o)[je](o)
                    }, g = function() {
                        c = 0,
                    ...
                    if (k)
                        i.prepend(mi(gn)),
                        ut(i, q + gn)[0].attachEvent("onresize", a);
                    else {
                        var A = T.createElement(dt);
                        A.setAttribute("tabindex", "-1"),
                        A.setAttribute(yt, gn),
                        A.onload = function() {
                ...
                if (i[0] === sr[0]) {
                    var L = function() {
                        var n = cr.css("direction")
                          ...
                          , r = 0
                          , e = !1;
                        return n !== R && (r = "ltr" === n ? (t[ze] = 0,
                        t[xe] = Ne,
                        o) : (t[ze] = Ne,
                        t[xe] = 0,
                        Mt.n ? -o : Mt.i ? 0 : o),
                        sr.children().eq(0).css(t),
                        i[_e](r)[je](o),
                        R = n,
                        e = !0),
                        e
                    ...
                    I = new n(function(n) {
                        if (Xt && !ir) {
                            ...
                            Ii.each(n, function() {
                                if (e = (t = this).target,
                                i = t.attributeName,
                                r = i === yt ? $n(t.oldValue, e.className) : i !== ki || t.oldValue !== e[ki].cssText)
                                    return !1
                            }),
                            r && de.update(Ne)
                        }
                            ...
                            Ii.each(n, function() {
                                return !(t = function o(n) {
                                    ...
                                    if ("attributes" === e && (t === yt || t === ki) && !Pt) {
                                        if (t === yt && Ii(r).hasClass(on))
                                            return $n(n.oldValue, r.getAttribute(yt));
                                        if (typeof r[i] != ht)
                                            return !0;
                                        if (null !== r[i](q + gn) || null !== r[i](q + Tn) || null !== r[i](q + Dn))
                                            return !1
                                    }
                                    return !0
                                }(this))
            ...
            function ii(n) {
                ...
                oe && !n ? t(cr, $, Xn) : (n && t(cr, $, Xn),
                t(cr, G, qn),
                t(cr, J, Bn)),
                Xt || n || cr.one("mouseover", qn)
            }
            function Yn(n) {
                return Hi.prvD(n),
                !1
            ...
            function oi() {
                var n = {};
                return $t && br && (n.w = bi(br.css(Te + Oe)),
                n.h = bi(br.css(Te + Ae)),
                n.c = yi(n, Qr),
                n.f = !0),
                (Qr = n).c || !1
            ...
            function $n(n, t) {
                ...
                var i, o, a, u, f, c = function h(n, t) {
                    ...
                    for (e in i)
                        o.push(e);
                    return o
                }(e, r), l = !1, s = Gr !== Ti && null !== Gr ? Gr.split(We) : [Ce], v = $r !== Ti && null !== $r ? $r.split(We) : [Ce], d = Ii.inArray(Qe, c);
                for (-1 < d && c.splice(d, 1),
                o = 0; o < c.length; o++)
                    if (0 !== (i = c[o]).indexOf(on)) {
                        for (f = u = !0,
                        a = 0; a < s.length; a++)
                            if (i === s[a]) {
                                u = !1;
            ...
            function ai() {
                if (!ir) {
                    var n, t, r, e, i = !Ur, o = be.w, a = be.h, u = {}, f = Tr || i, c = fr[0];
                    return u[Te + Oe] = Ce,
                    u[Te + Ae] = Ce,
                    u[Oe] = Ne,
                    fr.css(u),
                    n = c[Ci],
                    t = f ? Ri.max(n, c[Di] - 1) : 1,
                    u[Oe] = Tr ? Ne : He,
                    u[Te + Oe] = He,
                    u[Ae] = Ne,
                    fr.css(u),
            ...
            function ui(n, t, r, e) {
                ...
                Ze.f = Ze.f || r,
                ur = setTimeout(ui, ni)),
                !(Yt || o || ir || Xt && !r && a || "inline" === cr.css("display"))) {
                    ar = i,
                    n = n || Ze.h,
                    t = t || Ze.c,
                    r = r || Ze.f,
                    ...
                    t = t !== Ti && t,
                    r = r !== Ti && r,
                    !Et || jt.x && jt.y ? qt = xi(!0, {}, Wt.nativeScrollbarSize) : (qt.x = 0,
                    qt.y = 0),
                    pe = {
                        x: 3 * (qt.x + (jt.x ? 0 : 3)),
                        y: 3 * (qt.y + (jt.y ? 0 : 3))
                    ...
                    g && (zi(cr, Gr + We + Qe),
                    Si(cr, y !== Ti && null !== y && 0 < y.length ? y : Qe)),
                    I && (!0 === R ? (ei(),
                    _t.add(de)) : null === R && Ut ? (ei(),
                    _t.add(de)) : (_t.remove(de),
                    ri())),
                    N)
                        if (C)
                            if (vr ? vr.show() : (vr = Ii(mi(Ye)),
                            dr.before(vr)),
                            Jt)
                                lr.show();
                            else {
                                ...
                                ti(lr, function() {
                                    ...
                                    yi(n, E) && (Xt && kr && 0 < n.h || Tr && 0 < n.w ? ui() : (Xt && !kr && 0 === n.h || !Tr && 0 === n.w) && ui()),
                                    E = n
                                }),
                                Jt = !0,
                                null !== Vt && lr.css(Ae, Vt + "(100% + 1px)")
                            }
                        else
                            Jt && lr.hide(),
                            vr && vr.hide();
                    r && (sr.find("*").trigger(De),
                    Jt && lr.find("*").trigger(De));
                    var V, q = cr.css("direction"), B = wi(q, Dr, r), X = cr.css("box-sizing"), Y = wi(X, Ar, r), P = {
                        c: r,
                        t: bi(cr.css(we + ge)),
                        r: bi(cr.css(we + xe)),
                        b: bi(cr.css(we + Se)),
                    ...
                    bn.ih = bi(bn.h),
                    bn.iw = bi(bn.w),
                    bn.ch = -1 < bn.h.indexOf("px"),
                    bn.cw = -1 < bn.w.indexOf("px"),
                    bn.c = yi(bn, Or, r),
                    Dr = q,
                    Ar = X,
                    Tr = en,
                    ...
                    P.c || B || O || on || fn || Y || N) {
                        var gn = {}
                          , xn = {};
                        hi(mn, me, [-P.t, -P.r, -P.b, -P.l]),
                        k ? (hi(gn, Ce, [P.t, P.r, P.b, P.l]),
                        hi(Pt ? xn : pn, we)) : (hi(gn, Ce),
                        hi(Pt ? xn : pn, we, [P.t, P.r, P.b, P.l])),
                        dr.css(gn),
                        fr.css(xn)
                    }
                    be = yn();
                    var Sn = !!Pt && ai();
                    if (un && (fn || O || Y || bn.c || P.c || dn.c) ? (bn.cw && (pn[ke + Ae] = bn.ch ? bn.ih - P.ay + (Gt ? -nr : Qt) : Ce),
                    pn[Ae] = Ne) : (fn || O) && (pn[ke + Ae] = Ce,
                    pn[Ae] = He),
                    en && (on || O || Y || bn.c || P.c || dn.c || B) ? (bn.cw && (pn[ke + Oe] = bn.cw ? bn.iw - P.ax + (Gt ? -Zt : Kt) + (jt.y ? Ft.y : 0) : Ce),
                    pn[Oe] = Ne,
                    mn[ke + Oe] = He) : (on || O) && (pn[ke + Oe] = Ce,
                    pn[Oe] = He,
                    pn[Le] = Ce,
                    mn[ke + Oe] = Ce),
                    en ? (bn.cw || (pn[ke + Oe] = Ce),
                    mn[Oe] = Pt && j ? Sn.dw : Ne,
                    pn[Oe] = Ne,
                    pn[Le] = G) : mn[Oe] = Ce,
                    mn[Ae] = un ? (bn.ch || (pn[ke + Ae] = Ce),
                    Pt ? M ? Sn.dh : Ne : pr[0][Ai]) : Ce,
                    C && vr.css(mn),
                    pr.css(pn),
                    pn = {},
                    mn = {},
                    n || t || B || Y || O || on || en || fn || un || bn.c || H || _ || L || S || v || h || w || p || F || U || T || r) {
                        var zn = "overflow"
                          , Tn = zn + "-x"
                          , kn = zn + "-y"
                        ...
                        Ir = jn,
                        C) {
                            (jn.c || un || en) && (mn[Oe] = jn.w,
                            mn[Ae] = jn.h);
                            var Fn = mn[Oe] + (Gt ? Zt : -Kt)
                              , Mn = mn[Ae] + (Gt ? nr : -Qt)
                              , Un = {};
                            (!en || !en && dn.c) && (mn[Oe] = _n.w - (Gt ? 0 : Kt + Zt) - 1 - tr),
                            (!un || !un && dn.c) && (mn[Ae] = _n.h - (Gt ? 0 : Qt + nr) - 1 - rr),
                            en && bn.cw && bn.iw === Fn && (mn[Oe] = Fn + (Gt ? 0 : Kt) + 1),
                            un && bn.ch && bn.ih === Mn && (mn[Ae] = Mn + (Gt ? 0 : Qt) + 1),
                            en && (Hn.w < be.w || Pt && !z) && 0 === Kt && (Pt && (Un[Oe] = bi(mr.css(Oe)) - 1),
                            mn[Oe] -= 1),
                            un && (Hn.h < be.h || Pt) && 0 === Qt && (Pt && (Un[Ae] = bi(mr.css(Ae)) - 1),
                            mn[Ae] -= 1),
                            0 < Wn && (mn[Oe] = Ri.max(1, mn[Oe]),
                            mn[Ae] = Ri.max(1, mn[Ae])),
                            Pt && mr.css(Un),
                            vr.css(mn)
                        }
                        en && (pn[Oe] = He),
                        ...
                        (Xn.x || Yn) && (Zn.x = Qn.y && !Xn.y && !Pn),
                        (Xn.y || Pn) && (Zn.y = Qn.x && !Xn.x && !Yn),
                        Zn.xs = !!Zn.x && ($n.x || Xn.x),
                        Zn.ys = !!Zn.y && ($n.y || Xn.y);
                        var nt = {
                            x: Qn.x && Zn.xs,
                          ...
                          , tt = _r;
                        if (Gn.c = yi(Gn, _r, Re, Ie, r),
                        _r = Gn,
                        Qn.c = yi(Qn, Sr, Re, Ie, r),
                        Sr = Qn,
                        Zn.c = yi(Zn, zr, Re, Ie, r),
                        zr = Zn,
                        jt.x || jt.y) {
                            var rt = "px solid transparent"
                              ...
                              , it = {}
                              , ot = r;
                            (Qn.x || Qn.y) && (it.w = jt.y && Qn.y ? Bn.w + Ft.y : Ce,
                            it.h = jt.x && Qn.x ? Bn.h + Ft.x : Ce,
                            ot = wi(it, xr, r),
                            xr = it),
                            (Qn.c || Zn.c || Bn.c || B || on || fn || en || un || H) && (pn[me + G] = pn[ye + G] = Ce,
                            jt.x && Qn.x && Zn.xs ? (pn[me + Se] = un ? D ? Ce : Ft.x : Ce,
                            pn[ye + Se] = un || D ? Ce : Ft.x + rt) : (it.h = pn[me + Se] = pn[ye + Se] = Ce,
                            ot = !0),
                            jt.y && Qn.y && Zn.ys ? (pn[me + $] = en ? D ? Ce : Ft.y : Ce,
                            pn[ye + $] = D ? Ce : Ft.y + rt) : (it.w = pn[me + $] = pn[ye + $] = Ce,
                            ot = !0)),
                            D && (it.w = it.h = Ce,
                            ot = !0),
                            ot && (et[Oe] = Zn.y ? it.w : Ce,
                            et[Ae] = Zn.x ? it.h : Ce,
                            br || (br = Ii(mi(Xe)),
                            hr.prepend(br)),
                            br.css(et)),
                        ...
                        if (n || Qn.c || Zn.c || Bn.c || _ || Y || H || B || L || fn) {
                            ...
                            if (Qn.x && Zn.xs ? (at[Tn] = De,
                            D ? ut() : (at[Se] = -(jt.x ? Ft.x : qt.x),
                            he.h = jt.x ? Ft.y : 0)) : (at[Tn] = Ce,
                            ut()),
                            Qn.y && Zn.ys ? (at[kn] = De,
                            D ? ft() : (at[$] = -(jt.y ? Ft.y : qt.y),
                            he.w = jt.y ? Ft.x : 0)) : (at[kn] = Ce,
                            ft()),
                            (be.h < pe.x || be.w < pe.y) && (Qn.x && Zn.x && !jt.x || Qn.y && Zn.y && !jt.y) ? (at[we + ge] = pe.x,
                            at[me + ge] = -pe.x,
                            at[we + G] = pe.y,
                            at[me + G] = -pe.y) : at[we + ge] = at[me + ge] = at[we + G] = at[me + G] = Ce,
                            at[we + $] = at[me + $] = Ce,
                            Qn.x && Zn.x || Qn.y && Zn.y || Jn ? Pt && Jn && (gn[Tn] = gn[kn] = "hidden") : (!A || Yn || Xn.x || Pn || Xn.y) && (Pt && (gn[Tn] = gn[kn] = Ce),
                            at[Tn] = at[kn] = "visible"),
                            dr.css(gn),
                            hr.css(at),
                            at = {},
                            (Qn.c || Y || on || fn) && (!jt.x || !jt.y)) {
                                var ct = pr[0]
                                  , lt = ct[ki];
                                lt.webkitTransform = "scale(1)",
                                lt.display = "run-in",
                                ct[Oi],
                                lt.display = Ce,
                                lt.webkitTransform = Ce
                            }
                        }
                        if (pn = {},
                        B || on || fn)
                            if (er && en) {
                                ...
                                pr.css(Le, st),
                                vt !== Ri.round(pr.position().left) && (pn[ze] = vt)
                            } else
                                pn[ze] = Ce;
                        pr.css(pn);
                        var dt, ht, bt = "v" === s, pt = "h" === s, mt = "a" === s, wt = Hi.bind(fi, 0, !0, !0, nt.x), yt = Hi.bind(fi, 0, !1, !0, nt.y), gt = Hi.bind(fi, 0, !0, !1, nt.x), xt = Hi.bind(fi, 0, !1, !1, nt.y);
                        if (Zn.x || Zn.y ? Si(cr, Ve) : zi(cr, Ve),
                        Zn.x ? Si(cr, qe) : zi(cr, qe),
                        Zn.y ? Si(cr, Be) : zi(cr, Be),
                        B && (er ? Si(cr, Me) : zi(cr, Me)),
                        $t && Si(cr, Ue),
                        S) {
                            var St = function() {
                                wr.off(Fe, ve)
                            ...
                            fe ? (Si(cr, Ue),
                            zi(wr, [$e, Ge, Je, Ke].join(We)),
                            St()) : (zi(cr, Ue),
                            Si(wr, $e),
                            ce ? Si(wr, Ge) : le ? Si(wr, Je) : se && Si(wr, Ke),
                            St(),
                            wr.on(Fe, ve))
                        }
                        if ((v || _ || Zn.c || Qn.c || H) && (D ? H && (zi(cr, Ee),
                        D && (gt(),
                        xt())) : mt ? (nt.x ? wt() : gt(),
                        nt.y ? yt() : xt()) : bt ? (wt(),
                        yt()) : pt && (gt(),
                        ...
                        Pt && t) {
                            ...
                            if (zt) {
                                ...
                                dt = -1 < Ht.x,
                                (ht = -1 < Ht.y) && hr[je](Ht.y),
                                dt && (er && Pr && Mt.i ? hr[_e](0) : hr[_e](Ht.x))
                            }
                            Er = zt
                        }
                        er && Mt.i && jt.y && Qn.x && Pr && (f.l += he.w || 0),
                        dt || hr[_e](f.l),
                        ht || hr[je](f.t),
                        en && cr[_e](0),
                        un && cr[je](0),
                        B && di("onDirectionChanged", {
                            isRTL: er,
                            dir: q
                        }),
                    ...
                    $t && (Sr.c || Qr.c) && (Qr.f || oi(),
                    jt.y && Sr.x && pr.css(Te + Oe, Qr.w + Ft.y),
                    jt.x && Sr.y && pr.css(Te + Ae, Qr.h + Ft.x),
                    Qr.c = !1),
                    di("onUpdated", {
                        forced: r
                    })
            ...
            function Gn(n) {
                o = xi(!0, {}, o, ct.v(n, ct.t, !0)),
                or = xi(!0, {}, or, ct.v(n, ct.t, !1, !0))
            }
            function Jn(e) {
                ...
                e)
                    pr.contents().unwrap().unwrap().unwrap(),
                    zi(cr, r),
                    Pt ? (fr.removeAttr(ki),
                    u && t(),
                    zi(fr, r),
                    ...
                    if (Pt) {
                        var o = {}
                          , a = fr.parent();
                        u = !(a.hasClass(an) && 1 === a.children()[xt]),
                        or.sizeAutoCapable || (o[Oe] = fr.css(Oe),
                        o[Ae] = fr.css(Ae)),
                        u && fr.wrap(mi(an)),
                        (cr = fr.parent()).css(o).wrapInner(mi(yn + We + zn)).wrapInner(mi(pn + We + zn)).wrapInner(mi(bn + We + zn)),
                        pr = ut(cr, q + yn),
                        hr = ut(cr, q + pn),
                        dr = ut(cr, q + bn),
                        mr = Ii(mi(hn)),
                        ...
                        (cr = fr).wrapInner(mi(yn)).wrapInner(mi(pn)).wrapInner(mi(bn)),
                        pr = ut(cr, q + yn),
                        hr = ut(cr, q + pn),
                        dr = ut(cr, q + bn),
                        Si(fr, on);
                    Et && Si(hr, jt.x && jt.y ? wn : mn),
                    $t && Si(l, en),
                    sr = Ii(mi("os-resize-observer-host")),
                    cr.prepend(sr)
                }
            }
            function Kn(n) {
                ...
                ,
                (_ = {})[De] = function(n) {
                    return fr[_e](Mt.i && Pr ? 9999999 : 0),
                    fr[je](0),
                    Hi.prvD(n),
                    Hi.stpP(n),
                    !1
                ...
                Pt ? Ii.each(_, function(n, t) {
                    ...
                    !0 !== Fr && function s(n) {
                        ...
                        return ("s" === Wr.y || "v-s" === Wr.y) && ((c = l(a, n)) || Gt || (c = l(u, n))),
                        f && !c && ((c = l(i, n)) || Gt || (c = l(o, n))),
                        c
                    }((n = n.originalEvent || n).propertyName) && ui(Ne)
                }),
                n || (i = function(n) {
                    ir || (t !== Ti ? clearTimeout(t) : ((ie || oe) && ci(!0),
                    et() || Si(cr, Ee),
                    di("onScrollStart", n)),
                    si(!0),
                    si(!1),
            ...
            function Zn(g) {
                var i, x, S, z = nt(g), o = b.top !== b, T = z.xy, a = z.XY, k = De + z.LT, r = "active", O = 1, t = [16, 17];
                function e() {
                    O = .5
                }
                function u() {
                ...
                function A(n) {
                    ...
                    zi(z.t, r),
                    zi(z.s, r),
                    D.off($, s).off(P, A).off(K, f).off(Q, c).off(Z, Yn),
                    u(),
                    S !== (x = i = Ti) && (de.scrollStop(),
                    clearTimeout(S),
                    S = Ti),
                    n) {
                        var t = cr[0].getBoundingClientRect();
                        n.clientX >= t.left && n.clientX <= t.right && n.clientY >= t.top && n.clientY <= t.bottom || Bn(),
                        (ie || oe) && ci(!1)
                    }
                }
                function L(n) {
                    i = (i = hr[k]()) === Ti ? 0 : i,
                    (er && g && !Mt.n || !er) && (i = i < 0 ? 0 : i),
                    x = C && o ? n["screen" + a] : Hi.page(n)[T],
                    Si(H, In),
                    Si(z.h, r),
                    Si(z.s, r),
                    D.on($, s).on(P, A).on(Z, Yn),
                    !C && h || Hi.prvD(n),
                    Hi.stpP(n)
                }
                ...
                z.t.on(Fe, function(s) {
                    if (l(s)) {
                        var v, d, h = be[z.o], b = z.t.offset()[z.lt], n = s.ctrlKey, p = s.shiftKey, m = p && n, w = !0, y = function() {
                            if (!Yt) {
                                var n = x - b
                                  , t = z.i.tl
                                  , r = z.i.ho
                                ...
                                m ? (l.n = !1,
                                l[T] = u,
                                de.scroll(l, 130, "linear", function() {
                                    L(s)
                                })) : (hr[k](u),
                                L(s))) : (v = w ? c : v,
                                d = f ? v ? n <= r + e : r <= n : v ? r <= n : n <= r + e,
                                l[T] = v ? "-=" + h : "+=" + h,
                                de.scrollStop(),
                                de.scroll(l, o, "linear"),
                                S = d ? (clearTimeout(S),
                                de.scrollStop(),
                                Ti) : setTimeout(y, a),
                                w = !1)
                        ...
                        Si(z.t, r),
                        Si(z.s, r),
                        D.on(P, A).on(K, f).on(Q, c).on(Z, Yn),
                        y(),
                        Hi.prvD(s),
                        Hi.stpP(s)
                    }
            ...
            function li(n) {
                ...
                t[r.wh] = Ri.floor(100 * e * 1e6) / 1e6 + "%",
                et() || r.h.css(t),
                r.i.hl = r.h[0]["offset" + r.WH],
                r.i.hlr = e
            }
            function si(n, t) {
                t = t === Ti ? n ? hr[_e]() : hr[je]() : t;
                var r, e, i, o = er && n, a = {}, u = nt(n), f = "translate(", c = "transform", l = hr[0][De + u.WH] - hr[0]["client" + u.WH], s = u.i.hl, v = u.t[0]["offset" + u.WH], d = v - s;
                Mt.n && o && (l *= -1),
                i = t / l,
                i = isNaN(i) ? 0 : Ri.min(1, i),
                u.i.ms = l,
                u.i.cs = t,
                d *= u.i.csr = i,
                d = isNaN(d) ? 0 : d,
        ...
        return lt[vt] = function(n, r, e) {
            ...
            return n ? (n = n.length != Ti ? n : [n[0] || n],
            l(),
            0 < n.length && (a ? Ii.each(n, function(n, t) {
                (i = t) !== Ti && o.push(v(i, r, e, u, f))
            }) : Ii.each(n, function(n, t) {
                i = Tt(t),
                "!" === r && i instanceof lt[vt] || Hi.type(r) == ht && r(t, i) ? o.push(i) : r === Ti && o.push(i)
            }),
            t = 1 === o.length ? o[0] : o),
            t) : a || !r ? t : o
        }
