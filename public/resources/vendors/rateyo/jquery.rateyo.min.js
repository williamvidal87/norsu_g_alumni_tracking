...
!function(N) {
    ...
    function J(i, d) {
        ...
        var g, n, m, h, v, t, r = N("<div/>").addClass("jq-ry-group-wrapper").appendTo(i), y = N("<div/>").addClass("jq-ry-normal-group").addClass("jq-ry-group").appendTo(r), a = N("<div/>").addClass("jq-ry-rated-group").addClass("jq-ry-group").appendTo(r), w = 0, o = d.rating, l = !1;
        function s(t) {
            D(t) || (t = d.rating);
            var r = (o = t) / g
              , e = r * m;
        ...
        function u(t) {
            var r = d.starWidth = t;
            return n = window.parseFloat(d.starWidth.replace("px", "")),
            y.find("svg").attr({
                width: d.starWidth,
                height: r
            }),
        ...
        function f(t) {
            return d.normalFill = t,
            (d.rtl ? a : y).find("svg").attr({
                fill: d.normalFill
            }),
            i
        }
        ...
        function k(t) {
            if (d.multiColor) {
                ...
                b = t;
            return d.ratedFill = t,
            (d.rtl ? y : a).find("svg").attr({
                fill: d.ratedFill
            }),
            i
        }
        ...
        function C(t) {
            ...
            for (var r = 0; r < d.numStars; r++)
                y.append(N(d.starSvg || Q)),
                a.append(N(d.starSvg || Q));
            return u(d.starWidth),
            f(d.normalFill),
            p(d.spacing),
            s(),
            i
        ...
        function I(t) {
            ...
            if (c < o)
                ...
                n = g / 2,
                a = d.halfStar,
                ((i = d.fullStar) || a) && (i || a && n < e ? r += g - e : (r -= e,
                0 < e && (r += n))),
                u = r
            }
            return d.rtl && (u = s - u),
        ...
        function V(t) {
            ...
            i.attr("readonly", !0),
            L(),
            t || (i.removeAttr("readonly"),
            i.on("mousemove", M).on("mouseenter", M).on("mouseleave", T).on("click", R).on("rateyo.init", Y).on("rateyo.change", _).on("rateyo.set", B)),
            i
        }
        function E(t) {
            var r = t
              , e = d.maxValue;
            return "string" == typeof r && ("%" === r[r.length - 1] && (r = r.substr(0, r.length - 1),
            F(e = 100)),
            r = parseFloat(r)),
            function(t, r, e) {
                if (!(r <= t && t <= e))
                    throw Error("Invalid Rating, expected value between " + r + " and " + e)
            }(r, w, e),
            r = parseFloat(r.toFixed(d.precision)),
            $(parseFloat(r), w, e),
            d.rating = r,
            s(),
            l && i.trigger("rateyo.set", {
                rating: r
            }),
            i
        }
        ...
        this.destroy = function() {
            var n, a;
            return d.readOnly || L(),
            J.prototype.collection = (n = i.get(0),
            a = this.collection,
            N.each(a, function(t) {
                if (n === this.node) {
                    var r = a.slice(0, t)
                ...
                if (1 !== r.length || "object" != typeof r[0]) {
                    if (1 <= r.length && "string" == typeof r[0]) {
                        ...
                        return N.each(t, function(t, r) {
                            ...
                            var n = e[o];
                            if (!n)
                                throw Error("Method " + o + " does not exist!");
                            var a = n.apply(e, l);
                            s.push(a)
                        }),
                        s = 1 === s.length ? s[0] : s
