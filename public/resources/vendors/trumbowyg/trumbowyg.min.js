...
function(e, t, n, a) {
    ...
    var i = function(o, r) {
        ...
        i.$c = a(o),
        r = r || {},
        null != r.lang || null != l.langs[r.lang] ? i.lang = a.extend(!0, {}, l.langs.en, l.langs[r.lang]) : i.lang = l.langs.en,
        ...
        i.isIE = e.userAgent.indexOf("MSIE") !== -1 || e.appVersion.indexOf("Trident/") !== -1,
        i.init()
    };
    i.prototype = {
        ...
        setupUrlPrefix: function() {
            ...
            if (e)
                return "string" != typeof e ? "https://" : /:\/\/$/.test(e) ? e : e + "://"
        },
            ...
            e.$ed.on("dblclick", "img", e.o.imgDblClickHandler).on("keydown", function(t) {
                if (!t.ctrlKey && !t.metaKey || t.altKey) {
                    if (e.o.tabToIndent && "Tab" === t.key)
                        try {
                            return t.shiftKey ? e.execCmd("outdent", !0, null) : e.execCmd("indent", !0, null),
                            !1
                        } catch (n) {}
                } else {
                    i = !0;
                ...
                if (e.$c.trigger("tbw" + t.type),
                "blur" === t.type && a("." + n + "active-button", e.$btnPane).removeClass(n + "active-button " + n + "active"),
                e.o.autogrowOnEnter) {
                    if (e.autogrowOnEnterDontClose)
                        return;
                    "focus" === t.type ? (e.autogrowOnEnterWasFocused = !0,
                    e.autogrowEditorOnEnter()) : e.o.autogrow || (e.$ed.css({
            ...
            var t = this
              ...
              , l = a("<button/>", {
                ...
                mousedown: function() {
                    ...
                    !((t.$btnPane.hasClass(n + "disable") || t.$box.hasClass(n + "disabled")) && !a(this).hasClass(n + "active") && !a(this).hasClass(n + "not-disable")) && (t.execCmd(!!r && "dropdown" || o.fn || e, o.param || e, o.forceCss),
                    !1)
                }
            });
            if (r) {
        ...
        destroy: function() {
            ...
            e.isTextarea ? e.$box.after(e.$ta.css({
                ...
                height: ""
            }).removeClass(n + "editor").removeAttr("contenteditable").removeAttr("dir").html(e.html()).show()),
        ...
        dropdown: function(e) {
            ...
            l) {
                ...
                a("body", o).on("mousedown." + n.eventNamespace, function(e) {
                    i.is(e.target) || (a("." + r + "dropdown", n.$box).hide(),
        ...
        syncCode: function(e) {
            ...
            if (t.o.autogrow && (t.height = t.$ed.height(),
        ...
        semanticCode: function(e, t, n) {
            ...
            o.syncCode(e),
            o.o.semantic) {
                if (o.semanticTag("b", o.o.semanticKeepAttributes),
        ...
        semanticTag: function(e, t) {
            var n;
            if (null != this.o.semantic && "object" == typeof this.o.semantic && this.o.semantic.hasOwnProperty(e))
                n = this.o.semantic[e];
            else {
                if (this.o.semantic !== !0 || !this.DEFAULT_SEMANTIC_MAP.hasOwnProperty(e))
                    return;
                n = this.DEFAULT_SEMANTIC_MAP[e]
            }
            a(e, this.$ed).each(function() {
                var e = a(this);
                return 0 !== e.contents().length && (e.wrap("<" + n + "/>"),
                t && a.each(e.prop("attributes"), function() {
        ...
        createLink: function() {
            ...
            if (i && "A" === i.nodeName) {
                ...
                s = l.text(),
                e = l.attr("href"),
                o.o.minimalLinks || (t = l.attr("title"),
                n = l.attr("target"));
            ...
            o.openModalInsert(o.lang.createLink, c, function(e) {
                ...
                return o.o.minimalLinks || (e.title.length > 0 && n.attr("title", e.title),
        ...
        insertImage: function() {
            ...
            e.openModalInsert(e.lang.insertImage, t, function(t) {
                ...
                return n.attr("alt", t.alt),
                e.o.imageWidthModalEdit && n.attr({
                    width: t.width
                }),
                e.syncCode(),
                e.$c.trigger("tbwchange"),
        ...
        openModal: function(e, n) {
            var i = this
              , s = i.o.prefix;
            if (a("." + s + "modal-box", i.$box).length > 0)
                return !1;
        ...
        openModalInsert: function(e, t, n) {
            ...
            i.openModal(e, d).on(o, function() {
                ...
                a.each(t, function(t, n) {
                    ...
                    n.required && "" === s[o] ? (r = !1,
                    i.addErrorOnModalField(l, i.lang.required)) : n.pattern && !n.pattern.test(s[o]) && (r = !1,
                    i.addErrorOnModalField(l, n.patternError))
                }),
                r && (i.restoreRange(),
                n(s, t) && (i.syncCode(),
