!function(t, e) {
    ...
    var e = "SweetAlert2:"
      ...
      , S = n(["container", "shown", "height-auto", "iosfix", "popup", "modal", "no-backdrop", "toast", "toast-shown", "toast-column", "fade", "show", "hide", "noanimation", "close", "title", "header", "content", "actions", "confirm", "cancel", "footer", "icon", "image", "input", "file", "range", "select", "radio", "checkbox", "label", "textarea", "inputerror", "validation-message", "progress-steps", "active-progress-step", "progress-step", "progress-step-line", "loading", "styled", "top", "top-start", "top-end", "top-left", "top-right", "center", "center-start", "center-end", "center-left", "center-right", "bottom", "bottom-start", "bottom-end", "bottom-left", "bottom-right", "grow-row", "grow-column", "grow-fullscreen", "rtl"])
      , h = n(["success", "warning", "info", "question", "error"])
      , v = {
      ...
      , y = function(e, t, n) {
        f(e.classList).forEach(function(t) {
            -1 === p(S).indexOf(t) && -1 === p(h).indexOf(t) && e.classList.remove(t)
        }),
        t && t[n] && O(e, t[n])
    };
    function A(t, e) {
    ...
    var P, L = function(t) {
        ...
        var e;
        if ((e = R()) && (e.parentNode.removeChild(e),
        T([document.documentElement, document.body], [S["no-backdrop"], S["toast-shown"], S["has-column"]])),
        it())
            ...
            n.innerHTML = rt;
            var o, i, r, a, s, u, c, l, d, p, f, m, g = "string" == typeof (o = t.target) ? document.querySelector(o) : o;
            g.appendChild(n),
            i = t,
            ...
            a = g,
            "rtl" === window.getComputedStyle(a).direction && O(R(), S.rtl),
            s = K(),
            u = M(s, S.input),
            c = M(s, S.file),
            l = s.querySelector(".".concat(S.range, " input")),
            d = s.querySelector(".".concat(S.range, " output")),
            p = M(s, S.select),
            f = s.querySelector(".".concat(S.checkbox, " input")),
            m = M(s, S.textarea),
            u.oninput = at,
            c.onchange = at,
            p.onchange = at,
        ...
        t instanceof HTMLElement ? e.appendChild(t) : "object" === w(t) ? ct(e, t) : t && (e.innerHTML = t)
    }, ct = function(t, e) {
        if (t.innerHTML = "",
        0 in e)
    ...
    var ft = function(t, e) {
        var n, o, i, r, a = R();
        a && (n = a,
        "string" == typeof (o = e.backdrop) ? n.style.background = o : o || O([document.documentElement, document.body], S["no-backdrop"]),
        !e.backdrop && e.allowOutsideClick && m('"allowOutsideClick" parameter requires `backdrop` parameter to be set to `true`'),
        i = a,
        (r = e.position)in S ? O(i, S[r]) : (m('The "position" parameter is not valid, defaulting to "center"'),
        O(i, S.center)),
        function(t, e) {
        ...
        y(a, e.customClass, "container"),
        e.customContainerClass && O(a, e.customContainerClass))
    }
      , mt = {
        promise: new WeakMap,
    ...
    bt.text = bt.email = bt.password = bt.number = bt.tel = bt.url = function(t) {
        var e = M(K(), S.input);
        return "string" == typeof t.inputValue || "number" == typeof t.inputValue ? e.value = t.inputValue : x(t.inputValue) || m('Unexpected type of inputValue! Expected "string", "number" or "Promise", got "'.concat(w(t.inputValue), '"')),
        vt(e, t),
        e.type = t.input,
        e
    }
    ...
    var yt = function(t, e) {
        ...
        function(t, e) {
            ...
            if (e.input) {
                if (!bt[e.input])
                    return C('Unexpected type of input! Expected "text", "email", "password", "number", "tel", "select", "radio", "checkbox", "textarea", "file" or "url", got "'.concat(e.input, '"'));
                if (o) {
                    var c = bt[e.input](e);
                    j(c)
                }
      ...
      , kt = function(t, u) {
        var c = Z();
        if (!u.progressSteps || 0 === u.progressSteps.length)
            return q(c);
        j(c),
        c.innerHTML = "";
        var l = parseInt(null === u.currentProgressStep ? se.getQueueStep() : u.currentProgressStep);
        l >= u.progressSteps.length && m("Invalid currentProgressStep parameter, it should be less than progressSteps.length (currentProgressStep like JS arrays starts from 0)"),
        u.progressSteps.forEach(function(t, e) {
            var n, o, i, r, a = (n = t,
            ...
            o);
            if (c.appendChild(a),
            e === l && O(a, S["active-progress-step"]),
            e !== u.progressSteps.length - 1) {
                var s = (i = t,
                r = document.createElement("li"),
                O(r, S["progress-step-line"]),
      ...
      , Bt = function(t, e) {
        var n, o, i, r, a = X();
        y(a, e.customClass, "header"),
        kt(0, e),
        function(t, e) {
            var n = mt.innerParams.get(t);
            if (n && e.type === n.type && z())
                y(z(), e.customClass, "icon");
            else if (wt(),
            e.type)
                if (Ct(),
                -1 !== Object.keys(h).indexOf(e.type)) {
                    var o = D(".".concat(S.icon, ".").concat(h[e.type]));
                    j(o),
                    y(o, e.customClass, "icon"),
                    E(o, "swal2-animate-".concat(e.type, "-icon"), e.animation)
                } else
                    C('Unknown type! Expected "success", "error", "warning", "info" or "question", got "'.concat(e.type, '"'))
        }(t, e),
        function(t, e) {
            var n = F();
            if (!e.imageUrl)
        ...
        n = e,
        o = W(),
        I(o, n.title || n.titleText),
        n.title && ut(n.title, o),
        n.titleText && (o.innerText = n.titleText),
        y(o, n.customClass, "title"),
        i = e,
        r = tt(),
        y(r, i.customClass, "closeButton"),
        I(r, i.showCloseButton),
      ...
      , xt = function(t, e) {
        ...
        o = U(),
        V(o, "width", n.width),
        V(o, "padding", n.padding),
        n.background && (o.style.background = n.background),
        o.className = S.popup,
        n.toast ? (O([document.documentElement, document.body], S["toast-shown"]),
        O(o, S.toast)) : O(o, S.modal),
        y(o, n.customClass, "popup"),
        "string" == typeof n.customClass && O(o, n.customClass),
        E(o, S.noanimation, !n.animation),
        ft(0, e),
        Bt(t, e),
        yt(t, e),
        pt(0, e),
    ...
    var Ht = function() {
        null === v.previousBodyPadding && document.body.scrollHeight > window.innerHeight && (v.previousBodyPadding = parseInt(window.getComputedStyle(document.body).getPropertyValue("padding-right")),
        document.body.style.paddingRight = v.previousBodyPadding + function() {
      ...
      , Rt = function() {
        null !== v.previousBodyPadding && (document.body.style.paddingRight = v.previousBodyPadding + "px",
        v.previousBodyPadding = null)
    }
      , Dt = function() {
        if (b(document.body, S.iosfix)) {
            var t = parseInt(document.body.style.top, 10);
            T(document.body, S.iosfix),
    ...
    function Kt(t, e) {
        ...
        T([document.documentElement, document.body], [S.shown, S["height-auto"], S["no-backdrop"], S["toast-shown"], S["toast-column"]]),
        nt() && (Rt(),
        Dt(),
        _t(),
        zt())
    ...
    function Zt(t) {
        ...
        T(n, S.show),
        O(n, S.hide),
        lt && !b(n, S.noanimation) ? n.addEventListener(lt, Ft.bind(null, n, e, a)) : Kt(e, a),
        i(t || {}))
    }
    var Qt = function(t) {
    ...
    var te = function(t) {
        ...
        t.animation && (O(n, S.show),
        O(e, S.fade)),
        j(n),
        lt && !b(n, S.noanimation) ? (e.style.overflowY = "hidden",
        n.addEventListener(lt, Gt.bind(null, n, e))) : e.style.overflowY = "auto",
        O([document.documentElement, document.body, e], S.shown),
        t.heightAuto && t.backdrop && !t.toast && O([document.documentElement, document.body], S["height-auto"]),
    ...
    var ie, re = Object.freeze({
        ...
        enableConfirmButton: function() {
            k("Swal.disableConfirmButton()", "Swal.getConfirmButton().removeAttribute('disabled')"),
            Yt(this, ["confirmButton"], !1)
        },
        disableConfirmButton: function() {
            k("Swal.enableConfirmButton()", "Swal.getConfirmButton().setAttribute('disabled', '')"),
        ...
        getProgressSteps: function() {
            return k("Swal.getProgressSteps()", "const swalInstance = Swal.fire({progressSteps: ['1', '2', '3']}); const progressSteps = swalInstance.params.progressSteps"),
        ...
        _main: function(t) {
            ...
            !function(t) {
                for (var e in t)
                    Vt(i = e) || m('Unknown parameter "'.concat(i, '"')),
                    t.toast && (o = e,
                    -1 !== Mt.indexOf(o) && m('The parameter "'.concat(o, '" is incompatible with toasts'))),
                    jt(n = void 0) && k(n, jt(n));
                var n, o, i
            }(t);
            var v = a({}, Et, t);
            !function(e) {
            ...
            mt.domCache.set(this, b),
            xt(this, v),
            mt.innerParams.set(this, v);
            ...
            return new Promise(function(t) {
                ...
                Wt.swalPromiseResolve.set(h, t),
                v.timer && (Pt.timeout = new Jt(function() {
                    s("timer"),
                    delete Pt.timeout
                }
                ,v.timer)),
                ...
                for (var u = function(e) {
                    v.showLoaderOnConfirm && y.showLoading(),
                    v.preConfirm ? (h.resetValidationMessage(),
                    ...
                    case "click":
                        if (i)
                            ...
                            v.input) {
                                ...
                                v.inputValidator ? (h.disableInput(),
                                Promise.resolve().then(function() {
                                    return v.inputValidator(a, v.validationMessage)
                                }).then(function(t) {
                                    h.enableButtons(),
                                    h.enableInput(),
                                    t ? h.showValidationMessage(t) : u(a)
                                })) : h.getInput().checkValidity() ? u(a) : (h.enableButtons(),
                                h.showValidationMessage(v.validationMessage))
                            } else
                                u(!0);
                        else
                            r && (h.disableButtons(),
                ...
                }, o = b.popup.querySelectorAll("button"), i = 0; i < o.length; i++)
                    o[i].onclick = e,
                    o[i].onmouseover = e,
                    o[i].onmouseout = e,
                    o[i].onmousedown = e;
                ...
                v.toast)
                    ...
                    b.container.onmousedown = function() {
                        b.popup.onmouseup = function(t) {
                            ...
                            (t.target === b.popup || b.popup.contains(t.target)) && (r = !0)
                        }
                    }
                    ,
                ...
                var a, c, l, d, p, f, m, g = function(t, e) {
                    for (var n = et(v.focusCancel), o = 0; o < n.length; o++)
                ...
                Pt.keydownHandlerAdded = !1),
                v.toast || (Pt.keydownHandler = function(t) {
                    return function(t, e) {
                        ...
                        "Enter" !== t.key || t.isComposing)
                            if ("Tab" === t.key) {
                                ...
                                t.shiftKey ? g(i, -1) : g(i, 1),
                                t.stopPropagation(),
                                t.preventDefault()
                            } else
                                -1 !== ["ArrowLeft", "ArrowRight", "ArrowUp", "ArrowDown", "Left", "Right", "Up", "Down"].indexOf(t.key) ? document.activeElement === b.confirmButton && H(b.cancelButton) ? b.cancelButton.focus() : document.activeElement === b.cancelButton && H(b.confirmButton) && b.confirmButton.focus() : "Escape" !== t.key && "Esc" !== t.key || !0 !== B(e.allowEscapeKey) || (t.preventDefault(),
                ...
                ,
                Pt.keydownTarget = v.keydownListenerCapture ? window : b.popup,
                Pt.keydownListenerCapture = v.keydownListenerCapture,
                ...
                h.enableButtons(),
                h.hideLoading(),
                h.resetValidationMessage(),
                v.toast && (v.input || v.footer || v.showCloseButton) ? O(document.body, S["toast-column"]) : T(document.body, S["toast-column"]),
                "select" === v.input || "radio" === v.input ? (d = h,
                p = v,
                f = K(),
                m = function(t) {
                ...
                ,
                x(p.inputOptions) ? (At(),
                p.inputOptions.then(function(t) {
                    d.hideLoading(),
                    m(t)
                })) : "object" === w(p.inputOptions) ? m(p.inputOptions) : C("Unexpected type of inputOptions! Expected object, Map or Promise, got ".concat(w(p.inputOptions)))) : -1 !== ["text", "email", "number", "tel", "textarea"].indexOf(v.input) && x(v.inputValue) && (c = v,
                l = (a = h).getInput(),
                q(l),
                c.inputValue.then(function(t) {
                    l.value = "number" === c.input ? parseFloat(t) || 0 : t + "",
                    j(l),
                    l.focus(),
                    a.hideLoading()
                }).catch(function(t) {
                ...
                te(v),
                v.toast || (B(v.allowEnterKey) ? v.focusCancel && H(b.cancelButton) ? b.cancelButton.focus() : v.focusConfirm && H(b.confirmButton) ? b.confirmButton.focus() : g(-1, 1) : document.activeElement && "function" == typeof document.activeElement.blur && document.activeElement.blur()),
    ...
    function ae() {
        if ("undefined" != typeof window) {
            "undefined" == typeof Promise && C("This package requires a Promise library, please include a shim to enable it in this browser (See: https://github.com/sweetalert2/sweetalert2/wiki/Migration-from-SweetAlert-to-SweetAlert2#1-ie-support)"),
            ie = this;
            for (var t = arguments.length, e = new Array(t), n = 0; n < t; n++)
                e[n] = arguments[n];
