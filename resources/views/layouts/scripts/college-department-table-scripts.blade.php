<script >
    ...
    document.addEventListener('livewire:initialized', () => {
        ...
        @this.on('OpenCollegeDepartmentModal', (event) => {
            $('#CollegeDepartmentModal').modal('show');
        });
        
        @this.on('CloseCollegeDepartmentModal', (event) => {
            $('#CollegeDepartmentModal').modal('hide');
        });
        ...
        @this.on('ConfirmDelete', (CollegeDepartmentID) => {
            Swal.fire({
            title: "Are you sure?",
            ...
            if (result.isConfirmed) {
                Livewire.dispatch('DeleteThis',CollegeDepartmentID),
                Swal.fire({
                title: "Deleted!",
