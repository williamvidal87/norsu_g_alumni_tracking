<script >
    ...
    document.addEventListener('livewire:initialized', () => {
        ...
        @this.on('OpenTypeWorkModal', (event) => {
            $('#TypeWorkModal').modal('show');
        });
        
        @this.on('CloseTypeWorkModal', (event) => {
            $('#TypeWorkModal').modal('hide');
        });
        ...
        @this.on('ConfirmDelete', (TypeWorkID) => {
            Swal.fire({
            title: "Are you sure?",
            ...
            if (result.isConfirmed) {
                Livewire.dispatch('DeleteThis',TypeWorkID),
                Swal.fire({
                title: "Deleted!",
