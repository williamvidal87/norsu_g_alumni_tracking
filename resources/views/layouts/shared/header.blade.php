<header class="header">
    ...
    <div class="logo d-none d-sm-inline-flex">
        <a href="/dashboard">NORSU-G ALUMNI</a>
    </div>
        ...
        {{-- <li class="dropdown top-nav__notifications">
            ...
            <div class="dropdown-menu dropdown-menu-right dropdown-menu--block">
                <div class="dropdown-header">
                    ...
                    <div class="actions">
                        <a href="" class="actions__item zwicon-checkmark-square"
    ...
    <div class="clock d-none d-md-inline-block">
        <div class="time">
            <span class="time__hours"></span><span class="time__min"></span><span class="time__sec"></span> <span class="time__ampm"></span>
        </div>
    </div>
