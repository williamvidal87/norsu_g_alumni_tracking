...
<body class="font-sans antialiased dark:bg-black dark:text-white/50">
    <div class="bg-gray-50 text-black/50 dark:bg-black dark:text-white/50">
        <img id="background" class="absolute -left-20 top-0 max-w-[877px]"
            src="https://laravel.com/landingpage/assets/img/welcome/background.svg" />
        <div
                    ...
                    <div class="grid gap-6 lg:grid-cols-2 lg:gap-8">
                        <a href="https://laravel.com/docs" id="docs-card"
                            ...
                            <div id="screenshot-container" class="relative flex w-full flex-1 items-stretch">
                                <img src="https://laravel.com/landingpage/assets/img/welcome/docs-light.svg"
                                    ...
                                    onerror="
                                        ...
                                        " />
                                <img src="https://laravel.com/landingpage/assets/img/welcome/docs-dark.svg"
                                    alt="Laravel documentation screenshot"
...
<head>
    ...
    <!-- Compressed Styles -->
    <link href="landingpage/css/slides.min.css" rel="stylesheet" type="text/css">

    <!-- Custom Styles -->
    <!-- <link href="css/custom.css" rel="stylesheet" type="text/css"> -->

    <!-- jQuery 3.3.1 -->
    <script src="landingpage/ajax/libs/jquery/3.3.1/jquery.min.js"></script>

    <!-- Compressed Scripts -->
    <script src="landingpage/js/slides.min.js" type="text/javascript"></script>

    <!-- Custom Scripts -->
    <!-- <script src="js/custom.js" type="text/javascript"></script> -->

    <!-- Fonts and Material Icons -->
    <link rel="stylesheet" as="font" href="landingpage/css/font.css" />
...
<body class="slides chain simplifiedMobile animated">
    ...
    <nav class="panel top">
        <div class="sections desktop">
            <div class="left"><a style="width:82px;height:24px;font-family: fantasy;" href="/" title="Slides Framework">
                    <h2 style="letter-spacing: 2px;">NORSU-G ALUMNI</h2>
                </a></div>
            <div class="center">
        ...
        <div class="sections compact hidden">
            <div class="left"><a style="width:82px;height:24px;font-family: fantasy;" href="/" title="Slides Framework">
                    <h1 style="letter-spacing: 2px;">NORSU-G ALUMNI</h1>
                </a></div>
        ...
        <div class="content">
            <div class="container">
                <div class="wrap">
                    ...
                    <div class="fix-12-12">
                        <div class="fix-3-12">
                            <h2 style="font-family: fantasy;letter-spacing: 2px;">About Us</h2>
                        </div>
                        <p class="ae-3"><span class="opacity-8">Welcome to the official website of the NORSU-Guihulngan
                                Campus Alumni. At Negros Oriental State University Guihulngan Campus, we are dedicated
                                to nurturing not just students, but future leaders who will make significant
                                contributions to society. Our commitment to student development extends far beyond
                                graduation, recognizing the vital importance of maintaining a strong connection with our
                                alumni.</span>
                        </p>
                        <a href="{{ route('login') }}" class="button blue gradient crop ae-3 done">Get Started</a>
                    </div>

                </div>
            </div>
        </div>
        <div class="background" style="background-image:url(landingpage/assets/img/background/img-09.jpg)"></div>
    </section>
